...
trait IntegrationTestHarness extends KafkaServerTestHarness {
  ...
  override def setUp() {
    ...
    consumerConfig.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, classOf[org.apache.kafka.clients.consumer.ByteArrayDeserializer])
    consumerConfig.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, classOf[org.apache.kafka.clients.consumer.ByteArrayDeserializer])
