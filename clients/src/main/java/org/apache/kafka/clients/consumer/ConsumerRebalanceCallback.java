...
public interface ConsumerRebalanceCallback {
     ...
     * partition re-assignement. This method will be called after an offset re-assignement completes and before the consumer
     * starts fetching data.
     * <p>
     * It is guaranteed that all the processes in a consumer group will execute their {@link #onPartitionsRevoked(Consumer, Collection)}
     * callback before any instance executes its {@link #onPartitionsAssigned(Consumer, Collection)} callback.
     * 
     * @param partitions
